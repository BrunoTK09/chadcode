...
<br>
<br>
<!-- <div class="mosaic-single">
<div class="mosaic">
        <div class="container">
            <div class="default-title"> -->
                <center><h2 class="about-flex">LINGUAGENS MAIS USADAS NO MERCADO</h2></center>
                <br>
                <br>
                <br>
                <div class="mosaic-single">
                    <div class="mosaic-single-image" style="order: 1; box-shadow: -15px 20px 0px 5px #222222;">
                        <img src="./images/python-banner.jpg" alt="" srcset="">
                    </div> <!-- mosaic-single-image -->
                    <div class="mosaic-single-text">
                    <h2>PYTHON            <a href="#"> <img src="images/python.png" alt="python" href="#" width=50 height=50></a></h2>
                    <p>Python é uma linguagem de código aberto de forma fácil e acessível de aprender. Ela também é eficiente para projetos complexos, pois sua legibilidade e sua sintaxe são simples e diretas. <br><br>

                        Entendendo-a é possível programar para computadores, celulares e jogos, entre aplicações básicas e avançadas. Sua capacidade de processar grandes bases de dados acaba a levando para o meio da computação científica, ciência de dados e Inteligência Artificial. <br><br>
                ...
                <div class="mosaic-single">
                    <div class="mosaic-single-image" style="box-shadow: 15px 20px 0px 5px #222222;">
                        <img src="./images/csharp1-banner.jpg" alt="" srcset="">
                    </div> <!-- mosaic-single-image -->
                    <div class="mosaic-single-text">
                    <h2>C#    <a href="#"> <img src="images/c-sharp-c-logo.png" alt="python" href="#" width=50 height=50></a></h2>
                ...
                <div class="mosaic-single">
                    <div class="mosaic-single-image" style="order: 1;  box-shadow: -15px 20px 0px 5px #222222;">
                        <img src="./images/C++-banner.png" alt="" srcset="">
                    </div> <!-- mosaic-single-image -->
                    <div class="mosaic-single-text">
                    <h2>C++   <a href="#"> <img src="images/c-plus-plus-256.png" alt="python" href="#" width=50 height=50></a></h2>
                ...
                <div class="mosaic-single">
                    <div class="mosaic-single-image" style="box-shadow: 15px 20px 0px 5px #222222;">
                        <img src="./images/java-banner.jpg" alt="" srcset="">
                    </div> <!-- mosaic-single-image -->
                    <div class="mosaic-single-text">
                    <h2>JAVA   <a href="#"> <img src="images/java-256.png" alt="python" href="#" width=70 height=70></a></h2>
                ...
                <div class="mosaic-single">
                    <div class="mosaic-single-image" style="order: 1;  box-shadow: -15px 20px 0px 5px #222222;">
                        <img src="./images/php-banner.jpg" alt="" srcset="">
                    </div> <!-- mosaic-single-image -->
                    <div class="mosaic-single-text">
                    <h2>PHP    <a href="#"> <img src="images/php-logo.png" alt="python" href="#" width=100 height=50></a></h2>
                    <p>PHP é uma linguagem de script de uso geral, principalmente na escrita de códigos HTML. É uma das mais popularizadas por gerenciadores de conteúdo como Wordpress.<br><br>
                    ...
                    <div class="mosaic-single">
                    <div class="mosaic-single-image" style="box-shadow: 15px 20px 0px 5px #222222;">
                        <img src="./images/sql-banner.png" alt="" srcset="">
                    </div> <!-- mosaic-single-image -->
                    <div class="mosaic-single-text">
                    <h2>SQL   <a href="#"> <img src="images/Sql_data_base_with_logo.png" alt="python" href="#" width=100 height=50></a></h2>
                    <p>O SQL é uma linguagem que tem extrema relevância quando o assunto é manipulação de dados no banco, o que a torna uma ferramenta essencial para diversas áreas da tecnologia e para quem pretende seguir carreira em alguma delas.<br><br>
