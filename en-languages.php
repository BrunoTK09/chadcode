        ...
        <div class="container">
            <div class="default-title"> -->
                ...
                <div class="mosaic-single">
                    ...
                    <p>Python is an open-source language that’s easy and accessible to learn. It’s also efficient for complex projects, as its readability and syntax are simple and straightforward. <br><br>

                    Understanding it, it’s possible to program for computers, cell phones and games, between basic and advanced applications. The ability to process large databases ends up taking it into the field of scientific computing, data science and Artificial Intelligence. <br><br>
                ...
                <div class="mosaic-single">
                    ...
                    <p>PHP is a general-purpose scripting language, primarily for writing HTML code. It is one of the most popularized by content managers like Wordpress.<br><br>
                    ...
                    <p>SQL is a language that is extremely relevant when it comes to data manipulation in the database, which makes it an essential tool for several areas of technology and for those who intend to pursue a career in one of them.<br><br>
